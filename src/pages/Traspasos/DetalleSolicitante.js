  ...
  return (
    <div className="detalle-traspaso">
      ...
      <h3>Estado de la Solicitud</h3>
        ...
        <div className="estado-item">
            <strong>Respuesta del Presidente del Club:</strong> 
            <span className={solicitud.estado_club.toLowerCase() === 'pendiente' ? 'estado-pendiente' 
                : solicitud.estado_club.toLowerCase() === 'aprobado' ? 'estado-aprobado' 
                : 'estado-rechazado'}>
            {renderEstadoIcono(solicitud.estado_club)} {solicitud.estado_club}
            </span>
        </div>
        </div>
        ...
        {solicitud.estado_jugador === 'APROBADO' && solicitud.estado_club === 'APROBADO' ? (
            <div>
